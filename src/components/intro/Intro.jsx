      ...
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <p className="i-desc">
            ...
            <a href="img\alter_CV_2021-06-08_Ousseynou_Fofana.pdf" download="img/alter_CV_2021-06-08_Ousseynou_Fofana.pdf" className="btn" target="_blank" rel="noopener noreferrer">
                Télécharger CV
